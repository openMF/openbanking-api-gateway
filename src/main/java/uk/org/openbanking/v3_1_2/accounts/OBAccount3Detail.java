...
public class OBAccount3Detail {
    ...
    private List<OBAccount3DetailAccount> account = new ArrayList<>();
    ...
    public OBAccount3Detail account(List<OBAccount3DetailAccount> account) {
        this.account = account;
        return this;
    }

    public OBAccount3Detail addAccountItem(OBAccount3DetailAccount accountItem) {
